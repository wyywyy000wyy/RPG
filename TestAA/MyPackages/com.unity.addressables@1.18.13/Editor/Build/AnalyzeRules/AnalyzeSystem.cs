...
namespace UnityEditor.AddressableAssets.Build
{
    ...
    public static class AnalyzeSystem
    {
        ...
        public static List<string> FixDupRule()
        {
            CheckBundleDupeDependencies dupRule = Rules.Find(a => a.ruleName.Equals("Check Duplicate Bundle Dependencies")) as CheckBundleDupeDependencies;
            return dupRule.FixIssues2(AddressableAssetSettingsDefaultObject.Settings);
        }
