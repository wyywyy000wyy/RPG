...
local function s(t, opts)
    ...
    local function val2str(t, name, indent, insref, path, plainindex, level)
        ...
        if seen[t] then -- already seen this element
            ...
            return tag .. tostring(t) .. " -- [CYCLE REF]" .. comment("ref", level)
        end
        ...
        if ttype == "table" then
            if level >= maxl then
                return tag .. "{...} -- maxlevel:" .. maxl .. comment("maxlvl", level)
            end
            seen[t] = insref or spath
            if next(t) == nil then
            ...
            for n, key in ipairs(o) do
                ...
                if
                 ...
                 then
                    ...
                    if ktype == "table" or ktype == "function" or badtype[ktype] then
                        key = tostring(key)
                    end
